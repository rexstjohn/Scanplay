...
function Cannon(_x,_y){
	...
	this.HandleClick = function(e){
		...
		var cannonBall = new CannonBall(cannonMouthLocationX,cannonMouthLocationY,CANNON_BALL_RADIUS,CANNON_BALL_IMAGE_URL);
		GameResources.GameLoop.addGameObject(cannonBall);
		cannonBall.fire((this.rotation * (180 / Math.PI)) + ANGLE_OFFSET,CANNON_BALL_FORCE, new b2Vec2(this.x, this.y));
	}
}
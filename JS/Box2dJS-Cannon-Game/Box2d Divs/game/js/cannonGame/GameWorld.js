...
function GameWorld() {
	...
	var GRAVITY            = 300;
	var WALL_WIDTH         = 10;
	var BACKGROUND_IMAGE_URL = 'assets/art/background.png';
	...
	this.leftWall  = PhysicsUtils.CreateStaticBox(this.world,0, 125, WALL_WIDTH, CANVAS_HEIGHT);
	this.rightWall = PhysicsUtils.CreateStaticBox(this.world,CANVAS_WIDTH, 125, WALL_WIDTH, CANVAS_HEIGHT);
	
	// Add a background to our world.
	this.background = new Image();
	this.background.src = BACKGROUND_IMAGE_URL;
	...
	this.update = function(_timeStepLength,_iterationsPerSecond){
		...
		//GameResources.GameContext.drawImage(this.background,0,0, CANVAS_WIDTH,CANVAS_HEIGHT);
	}
}
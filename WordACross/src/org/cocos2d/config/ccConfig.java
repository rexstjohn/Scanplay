...
public class ccConfig {
    ...
    /** @def CC_DIRECTOR_DISPATCH_FAST_EVENTS
      ...
      If your game_activity_layout uses lot's of events (eg: touches) it might be a good idea to enable this feature.
    ...
    */
    ...
    /** @def CC_COMPATIBILITY_WITH_0_8
      ...
      It is recommended to disable compatibility once you have migrated your game_activity_layout to v0.9 to avoid class name polution

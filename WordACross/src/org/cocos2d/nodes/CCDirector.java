...
//        }
    ...
    /*public static boolean setDirectorType(int directorType) {
        ...
        if( type == CCDirectorTypeDisplayLink ) {
            ...
            if([currSysVer compare:reqSysVer how_to_play_activity_layout:NSNumericSearch] == NSOrderedAscending)
                return NO;
        }
...
//    	}
    ...
    */
    ...
    /** Resumes the paused CCScene
      ...
      The "delta time" will be 0 (as if the game_activity_layout wasn't paused)
    */
    public void resume() {
        if (!isPaused)
            return;

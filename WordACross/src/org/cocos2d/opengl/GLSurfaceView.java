 ...
 * using the {@link #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)} call.
 * <p>
 * <h3>Initializing GLSurfaceView</h3>
 * All you have to do to initialize a GLSurfaceView is call {@link #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)}.
 * However, if desired, you can modify the default behavior of GLSurfaceView by calling one or
 * more of these methods before calling setRenderer:
 * <ul>
 * <li>{@link #setDebugFlags(int)}
 * <li>{@link #setEGLConfigChooser(boolean)}
 * <li>{@link #setEGLConfigChooser(org.cocos2d.opengl.GLSurfaceView.EGLConfigChooser)}
 * <li>{@link #setEGLConfigChooser(int, int, int, int, int, int)}
 * <li>{@link #setGLWrapper(org.cocos2d.opengl.GLSurfaceView.GLWrapper)}
 * </ul>
 * <p>
 ...
 * Finally, you must call {@link #setRenderer} to register a {@link org.cocos2d.opengl.GLSurfaceView.Renderer}.
 * The renderer is
...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
     ...
     * {@link org.cocos2d.opengl.GLSurfaceView.GLWrapper#wrap(javax.microedition.khronos.opengles.GL)} method is called
     ...
     * <p>If this method is
     * called, it must be called before {@link #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)}
     * is called.
     * <p>
     ...
     * <p>If this method is called, it must be called before {@link #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)}
     * is called.
     * <p>This method only affects the behavior of the default EGLContexFactory and the
     * default EGLConfigChooser. If
     * {@link #setEGLContextFactory(org.cocos2d.opengl.GLSurfaceView.EGLContextFactory)} has been called, then the supplied
     * EGLContextFactory is responsible for creating an OpenGL ES 2.0-compatible context.
     * If
     * {@link #setEGLConfigChooser(org.cocos2d.opengl.GLSurfaceView.EGLConfigChooser)} has been called, then the supplied
     ...
     * <p>
     * This method can only be called after {@link #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)}
     *
...
//    }
     ...
     * }
     * </pre>
     * @see #setGLWrapper(org.cocos2d.opengl.GLSurfaceView.GLWrapper)
     */
     ...
     * this interface, and then call {@link org.cocos2d.opengl.GLSurfaceView#setRenderer} to
     ...
     * use the {@link org.cocos2d.opengl.GLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     *
     *
     * @see #setRenderer(org.cocos2d.opengl.GLSurfaceView.Renderer)
     */
...
//        void flushBuffers(GL10 gl, BufferLibrary library);
     ...
     * {@link org.cocos2d.opengl.GLSurfaceView#setEGLContextFactory(org.cocos2d.opengl.GLSurfaceView.EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link org.cocos2d.opengl.GLSurfaceView#setEGLWindowSurfaceFactory(org.cocos2d.opengl.GLSurfaceView.EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link org.cocos2d.opengl.GLSurfaceView#setEGLConfigChooser(org.cocos2d.opengl.GLSurfaceView.EGLConfigChooser)}
     */
...
//        }
        ...
        // is also created in the backgrounded game_activity_layout.  When the lock screen is closed
        // and the game_activity_layout comes forward, the window is fixed to the correct size
